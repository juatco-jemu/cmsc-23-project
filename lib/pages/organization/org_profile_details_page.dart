...
class OrgProfileDetailsPage extends StatefulWidget {
  const OrgProfileDetailsPage({super.key});
...
class _OrgProfileDetailsPageState extends State<OrgProfileDetailsPage> {
  ...
  Widget _buildUsername() {
    return Row(
      ...
      children: [
        Text("@${org.orgUsername!}",
            style: const TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
        Container(
          margin: const EdgeInsets.only(left: 8),
          padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
          decoration: BoxDecoration(
            color: org.orgStatus == "Approved" ? Colors.green : Colors.red,
            borderRadius: BorderRadius.circular(10),
          ),
          child: Text(org.orgStatus!.toUpperCase(),
              style:
        ...
        child: Material(
          ...
          child: TextFormField(
            ...
            decoration: CustomWidgetDesigns.customFormField(
                org.orgName, "Enter your new Organization name"),
  ...
  Widget get emailField => Padding(
        ...
        child: Material(
          ...
          child: TextFormField(
            readOnly: true,
            decoration: CustomWidgetDesigns.customFormField(
                org.orgEmail, "Enter your new Organization email"),
            // onSaved: (value) => setState(() => username = value),
            // validator: (value) {
            //   if (value == null || value.isEmpty) {
            //     return "Please enter your username";
  ...
  Widget get contactField => Padding(
        ...
        child: Material(
          ...
          child: TextFormField(
            readOnly: true,
            decoration: CustomWidgetDesigns.customFormField(
                org.orgContactNumber, "Enter your new Organization contact number"),
            // onSaved: (value) => setState(() => username = value),
            // validator: (value) {
            //   if (value == null || value.isEmpty) {
            //     return "Please enter your username";
